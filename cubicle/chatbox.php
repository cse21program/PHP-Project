      ...
      <div class="inbox_msg">
        ...
        <div class="mesgs">
          ...
          <?php 
           ...
           $query = mysqli_query($con , "SELECT * FROM chats WHERE (sender_id = '$id' AND receiver_id = '$club_id') OR (sender_id = '$club_id' AND receiver_id = '$id')");
           while($f_row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
             ...
             $receiver = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM club_details WHERE club_id='$club_id'"), MYSQLI_ASSOC);
             $receiver_profile_picture = $receiver['profile_picture'];
             if($club_id == $sender_id AND $id == $receiver_id) {

          
          ?>
            <div class="incoming_msg">
              <div class="incoming_msg_img"> <img src="<?php echo 'admin/'.$receiver_profile_picture;?>" alt="sunil"> </div>
